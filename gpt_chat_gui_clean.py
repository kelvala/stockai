...
class StockAnalyzerGUI:
    ...
    def setup_gui(self):
        ...
        # ChatGPT Browser Button
        self.chatgpt_button = ttk.Button(input_frame, text="🌐 OPEN IN CHATGPT", 
                                        command=self.open_chatgpt_browser,
                                        style="ChatGPT.TButton")
        self.chatgpt_button.grid(row=2, column=0, pady=(5, 0))
        
        # Configure button styles for larger appearance
        style = ttk.Style()
